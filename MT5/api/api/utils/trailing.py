...
import traceback
import pandas as pd
from api.services.trade import trade_service
from api.utils import helpers
from api.db.crud import get_trade_by_ticket, mutate_trade
from api.db.database import SessionLocal
from api.utils.constants import TRAILING_STOP_STEPS
