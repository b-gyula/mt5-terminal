...
"""
**NOTE:** The modified `mt5linux` in the packages folder can be used as the client for it. 
...
# /opt/wineprefix/drive_c/Python/python.exe
# $WINEPREFIX/drive_c/Python/python.exe
# C:\\Python\\python.exe
# python.exe -c "import sys; print(sys.path)"

# References:
# https://github.com/nicholishen/pymt5adapter---DEPRECATED/tree/master
# https://github.com/boxxello/MetaTrader5-Listener-Telegram
"""
